...
class App extends Component {
  constructor(props) {
    ...
    this.handleUploadDatasetFromDropbox = this.handleUploadDatasetFromDropbox.bind(
      this
    );
  }
  ...
  handleUploadDataset(files, reject) {
    ...
    postFileData('upload-dataset', files, {
            ...
            <div className="card text-center data-upload-card">
              ...
              <div className="card-body">
                {this.state.currentTab === 'local' && (
                  ...
                  >
                    <div>
                      Click to upload a file (or drag a file.) File must be .cab
                      files.
                    </div>
                  </DropZone>
                )}
                  ...
                  <div>
                    ...
                    <div className="text-caption">
                      <p className="figure-caption">
                        The path of the folder in Dropbox. '/' represents the
                        root folder in Dropbox (when you visit
                        https://www.dropbox.com/home). When you specify a
                        Dropbox folder, all .cab files within the folder will be
                        downloaded.
                      </p>
                    </div>
                    <div className="input-group mb-3">
